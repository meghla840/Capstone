(function () {
    ...
    function renderPostCard(post) {
        ...
        meta.innerHTML = `<div class="font-semibold">${escapeHtml(post.title)}</div>
            <div class="text-xs text-slate-500">${escapeHtml(post.author.name)} · ${timeAgo(new Date(post.createdAt))}</div>`;
    ...
    function initBrowse() { attachTabs(); attachMenuToggle(); renderAllPosts('all'); }
